...
private:
    ...
    void labelQuadGroup(std::vector<ChessboardQuadPtr>& quad_group, cv::Size patternSize,
                        bool firstRun);
    ...
    void generateQuads(std::vector<ChessboardQuadPtr>& quads, cv::Mat& image, int flags,
    ...
    bool matchCorners(ChessboardQuadPtr& quad1, int corner1, ChessboardQuadPtr& quad2,
                      int corner2) const;
