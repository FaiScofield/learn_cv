...
public:
    ...
    // end points
    Spline()
        : _valid(false), _BCLow(FIXED_2ND_DERIV_BC), _BCHigh(FIXED_2ND_DERIV_BC), _BCLowVal(0),
          _BCHighVal(0), _type(CUBIC)
    {
    }
...
private:
    ...
    template <class T> bool InvertMatrix(ublas::matrix<T> A, ublas::matrix<T>& inverse)
    {
